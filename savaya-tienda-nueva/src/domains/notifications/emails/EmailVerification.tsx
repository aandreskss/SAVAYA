  ...
  return (
    <html lang="es">
      <head>
        ...
        <title>Verifica tu correo — SAVAYA</title>
      </head>
                    ...
                    <tr>
                      <td style={{ padding: '40px 32px' }}>
                        ...
                        <p style={{ margin: '0 0 24px', fontSize: '15px', color: '#4A4843', lineHeight: '1.6' }}>
                          Gracias por crear tu cuenta en SAVAYA. Haz clic en el botón de abajo
                          para verificar tu correo y activar todas las funciones de tu cuenta.
                        </p>
                        ...
                        <p style={{ margin: '32px 0 0', fontSize: '12px', color: '#7C7872' }}>
                          ...
                          <br />
                          <a href={verifyUrl} style={{ color: '#CA8C31', wordBreak: 'break-all' }}>{verifyUrl}</a>
                        </p>
                      </td>
                    </tr>
