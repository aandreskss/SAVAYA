  ...
  return (
    <CartProvider>
      ...
      <Script
        ...
        nonce={nonce}
      >{`(function(){var collector="https://sync-lead-eight.vercel.app/api/collect/4bcfefdb0d9ce9223485776e1eb29f06287ff496865e88f6b977aedd13547279";function send(n,p){var b={};if(p&&typeof p==="object")Object.keys(p).forEach(function(k){b[k]=true;});fetch(collector,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({eventName:n,pageUrl:window.location.href,environment:"production",parameters:b})});}window.__synclead_collect=send;function wrap(orig){function w(){var a=Array.prototype.slice.call(arguments);if(a[0]==="track"||a[0]==="trackCustom")send(a[1],a[2]||{});return orig.apply(this,arguments);}w.push=orig.push;w.loaded=orig.loaded;w.version=orig.version;w.queue=orig.queue;w._fbq=orig;return w;}function tryWrap(){if(typeof window.fbq==="function"&&!window.fbq._sl_wrapped){var wrapped=wrap(window.fbq);wrapped._sl_wrapped=true;window.fbq=wrapped;if(window._fbq&&!window._fbq._sl_wrapped)window._fbq=wrapped;}}tryWrap();Object.defineProperty(window,"fbq",{configurable:true,set:function(v){Object.defineProperty(window,"fbq",{configurable:true,writable:true,value:v});if(typeof v==="function"&&!v._sl_wrapped)setTimeout(tryWrap,0);}});})()`}</Script>
      <GenderSync />
