...
export default async function ShopLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <CartProvider>
      ...
      />
      <SiteTracker />
      <Script id="sl-config" strategy="beforeInteractive" nonce={nonce}>{`window.SyncLeadKey="slk_498e6defa412afdc97f833254c6ef829433941f17107ebfa";window.SyncLeadHost="https://sync-lead-eight.vercel.app";`}</Script>
