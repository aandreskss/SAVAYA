  ...
  return (
    <CartProvider>
      ...
      <Script
        ...
        nonce={nonce}
      >{`(function(){var collector="https://sync-lead-eight.vercel.app/api/collect/cb4cb7db3b76cb7dce53fbf1e88432b992149268f36cc2ca4246bb590e58dc53";function sendToDiagnostic(eventName,params){var boolParams={};if(params&&typeof params==="object"){Object.keys(params).forEach(function(k){boolParams[k]=true;});}fetch(collector,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({eventName:eventName,pageUrl:window.location.href,environment:"production",parameters:boolParams})});}window.__synclead_collect=sendToDiagnostic;function wrapFbq(original){if(original&&original._synclead_wrapped)return original;var wrapper=function(){var args=Array.prototype.slice.call(arguments);if(args[0]==="track"||args[0]==="trackCustom"){sendToDiagnostic(args[1],args[2]||{});}if(typeof wrapper.callMethod==="function"){return wrapper.callMethod.apply(wrapper,args);}return original.apply(this,arguments);};try{var skip={length:1,name:1,prototype:1,caller:1,arguments:1};Object.getOwnPropertyNames(original).forEach(function(key){if(skip[key])return;Object.defineProperty(wrapper,key,{get:function(){return original[key];},set:function(v){original[key]=v;},configurable:true,enumerable:true});});}catch(e){}wrapper._synclead_wrapped=true;return wrapper;}if(typeof window.fbq==="function"){window.fbq=wrapFbq(window.fbq);if(window._fbq&&!window._fbq._synclead_wrapped)window._fbq=window.fbq;}else{Object.defineProperty(window,"fbq",{configurable:true,set:function(val){Object.defineProperty(window,"fbq",{configurable:true,writable:true,value:typeof val==="function"?wrapFbq(val):val;Object.defineProperty(window,"fbq",{configurable:true,writable:true,value:w});if(w&&w._synclead_wrapped&&window._fbq&&!window._fbq._synclead_wrapped)window._fbq=w;}});}})()`}</Script>
      <GenderSync />
