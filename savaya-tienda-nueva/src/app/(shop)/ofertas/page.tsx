...
export async function generateMetadata({ searchParams }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Ofertas — SAVAYA',
    description: 'Aprovecha las mejores ofertas en calzado SAVAYA de autor venezolano',
    alternates: {
      canonical: 'https://www.savayavzla.com/ofertas',
    },
...
export default async function OfertasPage({ searchParams }: Props) {
  ...
  // Force onlyOnSale — merge with user filters
  const filters = {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-8">
      ...
      <div className="mt-6 mb-8">
        <h1 className="font-display text-4xl font-bold text-text-primary">Ofertas</h1>
        <p className="text-text-secondary mt-2">
          Los mejores precios en calzado SAVAYA — solo por tiempo limitado
        </p>
