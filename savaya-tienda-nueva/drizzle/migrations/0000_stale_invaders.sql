...
CREATE TYPE "public"."page_section_type" AS ENUM('announcement_bar', 'hero', 'shop_by_category', 'product_carousel', 'editorial_block', 'split_block', 'benefits_block', 'newsletter', 'banner_row');--> statement-breakpoint
CREATE TYPE "public"."customer_tag" AS ENUM('new', 'returning', 'vip', 'high_ticket', 'inactive', 'frequent', 'wholesale');--> statement-breakpoint
CREATE TYPE "public"."discount_applies_to_type" AS ENUM('all', 'category', 'product', 'collection', 'customer');--> statement-breakpoint
CREATE TYPE "public"."discount_type" AS ENUM('percentage', 'fixed_usd');--> statement-breakpoint
CREATE TYPE "public"."exchange_rate_currency" AS ENUM('usd', 'eur');--> statement-breakpoint
CREATE TYPE "public"."inventory_movement_type" AS ENUM('purchase', 'sale', 'adjustment', 'return', 'cancellation', 'correction', 'reservation', 'reservation_release');--> statement-breakpoint
CREATE TYPE "public"."notification_status" AS ENUM('sent', 'failed', 'skipped');--> statement-breakpoint
CREATE TYPE "public"."notification_type" AS ENUM('email', 'whatsapp_link', 'sms');--> statement-breakpoint
CREATE TYPE "public"."order_status" AS ENUM('pending_payment', 'payment_under_review', 'payment_rejected', 'paid', 'preparing', 'shipped', 'delivered', 'cancelled', 'refunded');--> statement-breakpoint
CREATE TYPE "public"."reservation_payment_type" AS ENUM('full', 'partial_20', 'partial_35', 'partial_50');--> statement-breakpoint
CREATE TYPE "public"."payment_currency" AS ENUM('usd', 'ves');--> statement-breakpoint
CREATE TYPE "public"."payment_method_type" AS ENUM('zelle', 'pago_movil', 'bank_transfer', 'usdt_trc20', 'binance_pay', 'cash');--> statement-breakpoint
CREATE TYPE "public"."proof_status" AS ENUM('pending', 'approved', 'rejected');--> statement-breakpoint
CREATE TYPE "public"."role_name" AS ENUM('super_admin', 'admin', 'catalog', 'inventory', 'sales', 'finance', 'customer_service', 'marketing', 'analyst');--> statement-breakpoint
CREATE TYPE "public"."shipping_zone_type" AS ENUM('local_delivery', 'national_agency', 'pickup');--> statement-breakpoint
...
ALTER TABLE "coupon_usages" ADD CONSTRAINT "coupon_usages_discount_id_discounts_id_fk" FOREIGN KEY ("discount_id") REFERENCES "public"."discounts"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "exchange_rates" ADD CONSTRAINT "exchange_rates_override_by_users_id_fk" FOREIGN KEY ("override_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "notification_log" ADD CONSTRAINT "notification_log_customer_id_customers_id_fk" FOREIGN KEY ("customer_id") REFERENCES "public"."customers"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "payment_proofs" ADD CONSTRAINT "payment_proofs_payment_method_id_payment_methods_id_fk" FOREIGN KEY ("payment_method_id") REFERENCES "public"."payment_methods"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "shipping_cities" ADD CONSTRAINT "shipping_cities_zone_id_shipping_zones_id_fk" FOREIGN KEY ("zone_id") REFERENCES "public"."shipping_zones"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "shipping_rates" ADD CONSTRAINT "shipping_rates_city_id_shipping_cities_id_fk" FOREIGN KEY ("city_id") REFERENCES "public"."shipping_cities"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "order_attributions_utm_source_idx" ON "order_attributions" USING btree ("utm_source");--> statement-breakpoint
CREATE INDEX "order_attributions_utm_campaign_idx" ON "order_attributions" USING btree ("utm_campaign");--> statement-breakpoint
CREATE INDEX "audit_log_actor_id_idx" ON "audit_log" USING btree ("actor_id");--> statement-breakpoint
CREATE INDEX "audit_log_action_idx" ON "audit_log" USING btree ("action");--> statement-breakpoint
CREATE INDEX "audit_log_resource_type_id_idx" ON "audit_log" USING btree ("resource_type","resource_id");--> statement-breakpoint
...
CREATE INDEX "collections_starts_at_ends_at_idx" ON "collections" USING btree ("starts_at","ends_at");--> statement-breakpoint
...
CREATE INDEX "product_media_is_primary_idx" ON "product_media" USING btree ("product_id","is_primary");--> statement-breakpoint
CREATE UNIQUE INDEX "product_variants_product_color_size_idx" ON "product_variants" USING btree ("product_id","color_id","size_id");--> statement-breakpoint
...
CREATE INDEX "banners_starts_at_ends_at_idx" ON "banners" USING btree ("starts_at","ends_at");--> statement-breakpoint
...
CREATE INDEX "page_sections_is_active_sort_idx" ON "page_sections" USING btree ("page_id","is_active","sort_order");--> statement-breakpoint
CREATE INDEX "pages_is_active_idx" ON "pages" USING btree ("is_active");--> statement-breakpoint
CREATE INDEX "popups_is_active_idx" ON "popups" USING btree ("is_active");--> statement-breakpoint
CREATE INDEX "popups_starts_at_ends_at_idx" ON "popups" USING btree ("starts_at","ends_at");--> statement-breakpoint
CREATE INDEX "addresses_customer_id_idx" ON "addresses" USING btree ("customer_id");--> statement-breakpoint
CREATE INDEX "addresses_is_default_idx" ON "addresses" USING btree ("customer_id","is_default");--> statement-breakpoint
...
CREATE INDEX "customers_total_spent_usd_idx" ON "customers" USING btree ("total_spent_usd");--> statement-breakpoint
CREATE INDEX "coupon_usages_discount_id_idx" ON "coupon_usages" USING btree ("discount_id");--> statement-breakpoint
...
CREATE INDEX "discounts_starts_at_ends_at_idx" ON "discounts" USING btree ("starts_at","ends_at");--> statement-breakpoint
CREATE INDEX "discounts_applies_to_type_id_idx" ON "discounts" USING btree ("applies_to_type","applies_to_id");--> statement-breakpoint
CREATE INDEX "exchange_rates_currency_created_at_idx" ON "exchange_rates" USING btree ("currency","created_at");--> statement-breakpoint
CREATE INDEX "exchange_rates_is_manual_override_idx" ON "exchange_rates" USING btree ("is_manual_override");--> statement-breakpoint
...
CREATE INDEX "notification_log_customer_id_idx" ON "notification_log" USING btree ("customer_id");--> statement-breakpoint
...
CREATE INDEX "payment_methods_sort_order_idx" ON "payment_methods" USING btree ("sort_order");--> statement-breakpoint
...
CREATE INDEX "payment_proofs_created_at_idx" ON "payment_proofs" USING btree ("created_at");--> statement-breakpoint
...
CREATE INDEX "shipping_cities_zone_id_idx" ON "shipping_cities" USING btree ("zone_id");--> statement-breakpoint
CREATE INDEX "shipping_cities_is_active_idx" ON "shipping_cities" USING btree ("is_active");--> statement-breakpoint
CREATE INDEX "shipping_cities_state_idx" ON "shipping_cities" USING btree ("state");--> statement-breakpoint
CREATE INDEX "shipping_methods_zone_id_idx" ON "shipping_methods" USING btree ("zone_id");--> statement-breakpoint
CREATE INDEX "shipping_methods_is_active_idx" ON "shipping_methods" USING btree ("is_active");--> statement-breakpoint
CREATE INDEX "shipping_rates_method_id_idx" ON "shipping_rates" USING btree ("method_id");--> statement-breakpoint
CREATE INDEX "shipping_rates_city_id_idx" ON "shipping_rates" USING btree ("city_id");--> statement-breakpoint
CREATE INDEX "shipping_zones_is_active_idx" ON "shipping_zones" USING btree ("is_active");--> statement-breakpoint
CREATE INDEX "shipping_zones_type_idx" ON "shipping_zones" USING btree ("type");--> statement-breakpoint
CREATE INDEX "admin_users_is_active_idx" ON "admin_users" USING btree ("is_active");--> statement-breakpoint
CREATE INDEX "wholesale_leads_status_idx" ON "wholesale_leads" USING btree ("status");--> statement-breakpoint
