...
export default function NewArrivals({ products }: { products: Product[] }) {
  ...
  return (
    <section className="py-14 bg-gray-bg/50">
      <div className="px-4 md:px-8">
        <div className="flex items-end justify-between mb-6">
          <div>
            <p className="font-heading text-[10px] tracking-[0.2em] uppercase text-gray-text mb-1.5">
              Recién llegados
            </p>
            <h2 className="font-display text-2xl font-bold">Nuevos ingresos</h2>
          </div>
          <Link
